...
class Selectplaninput extends StatefulWidget {
  ...
  @override
  State<Selectplaninput> createState() => _SelectplaninputState();
}

class _SelectplaninputState extends State<Selectplaninput> {
                                ...
                                return InkWell(
                                  onTap: () {
                                    ...
                                    widget.controller.text =
                                        widget.listitems[index].planName;

                                    widget.changed();

                                    User.planuniquid =
                                        widget.listitems[index].uniqueId;
